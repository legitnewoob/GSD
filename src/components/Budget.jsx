...
import {
  Plus, Trash2, Edit3, Check, X, CreditCard, ChevronDown, ChevronUp, AlertTriangle, History, RefreshCw,
} from 'lucide-react';
...
function MonthHistoryPanel() {
  ...
  return (
    <div className={panelBase}>
      ...
      <p className="text-xs text-game-dim mb-4">A snapshot is captured automatically when a new month starts, right before fixed spend resets.</p>
      ...
      {snapshot && (
        <div className="space-y-4">
          <div className="grid grid-cols-2 sm:grid-cols-4 gap-3">
            ...
            <div className="bg-slate-900/60 rounded-xl p-3 border border-slate-700">
              <div className="text-xs text-game-dim uppercase tracking-wide mb-1">Fixed spend</div>
            ...
            <div className="bg-slate-900/60 rounded-xl p-3 border border-slate-700">
              <div className="text-xs text-game-dim uppercase tracking-wide mb-1">Daily pool spend</div>
