...
export function DailyJournal({
  ...
  return (
    <div className="max-w-5xl mx-auto p-4 sm:p-6 space-y-6">
      <div className="sticky top-2 z-30 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3 sm:gap-4 rounded-2xl bg-game-bg/90 backdrop-blur-md px-3 py-2">
        <div>
